...
# Variavel + dado
# Nas linhas 1 e 2, criamos variáveis do tipo String, ou seja, o conteudo de uma variavel strinf deve estar entre aspas/aspas duplas (") ou entre aspas simples (').
